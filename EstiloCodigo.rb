...
# Un buen programador no solamente escribe código, si no que lo organiza y limpia recurrentemente. 
# Para tener un código digno hay que seguir una serie de convenciones gramaticales y de syntaxis.

# Es importante que tu equipo escriba código bajo las reglas de la misma guía de estilo para tener un 
# código unificado. Existen muchas guías de estilo no importa cual utilices siempre y cuando todos en tu 
# equipo utilicen la misma. Piensa que algún día alguien nuevo entrará al equipo o el código será utilizado 
# por otras personas por lo que te recomendamos utilizar Guías de Estilo reconocidas y ampliamente utilizadas.

# El objetivo de estas guías es que los programadores de Ruby escriban código al cual puedan dar mantenimiento 
# otros programadores.
...
# Actividades
# Para este ejercicio se te entregará un programa donde el código es un desastre. Utilizando la siguiente 
# Guía de Estilo de Ruby, limpia el código y pon atención en las secciones de Estructura del Código Fuente, 
# Sintaxis, Nombres y Comentarios.

# Puedes hacer las modificaciones que gustes al código pero no puedes romper el programa ya que en el drivers 
# code todo debe de a resolverse como verdadero.
...
# Utiliza espacios entre operadores, después de las comas, dos puntos y puntos y comas. Los espacios en blanco
#  pueden (en su mayoría) irrelevantes para el intérprete de Ruby, pero su uso adecuado es la clave para escribir 
#  código fácil de leer.
# Sintaxis
# Utiliza def con paréntesis cuando tengas argumentos y no dejes espacio entre el nombre del método y el paréntesis, 
# ej. def(argumento)
...
# Los nombres de los métodos que afirman (métodos que devuelven un valor booleano) deben terminar con un
#  signo de pregunta. (ejemplo: Array#empty?). Los métodos que no devuelvan un booleano, no deben terminar con un
#   signo de pregunta.
# Comentarios
...
# Si se son necesarias varias líneas para describir el problema, las líneas subsiguientes tienen que tener una 
# sangría de dos espacios después del #.
